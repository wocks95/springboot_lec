...
import com.min.app01_1.dto.BoardDto;
import com.min.app01_1.mapper.IBoardMapper;
...
class ApplicationTests {
  ...
  private IBoardMapper boardMapper;
	...
	void board_detail_테스트() {
	  Assertions.assertEquals("두 번째 게시글", boardMapper.selectBoardById(1).getTitle());
	}
	...
	void board_update_테스트() {
	  Assertions.assertEquals(1, boardMapper.updateBoard("수정 블로그", "소주마신건 안비밀",1));
	}
